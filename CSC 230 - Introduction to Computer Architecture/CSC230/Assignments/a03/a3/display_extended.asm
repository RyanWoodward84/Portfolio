...
.cseg
	ldi r20, 0x40		; This is used to set the delay timer
...
;;Initial section in order to display the first 2 lines in full
	...
	;;Updating the position of the name on the second line
	call delay
	call delay
	call lcd_clr
	call display_line1
...
;; This is the place where the stars will flash	
