...
public class CallingCard extends Card
{
	...
	/**
	 * This method will determine whether two Calling Cards have the same state
	 * @param test This is the test Calling card that will be compared
	 * @return Returns a true or false value depending on whether the states are equal or not
	 * @pre It is assumed that a non null CallingCard will be passed as an argument
	 * @post Will return true or false depending on whether the states of the two Calling Cards are equal
	 */
	public boolean equals(CallingCard test)
	{
		if(super.equals(test) && (this.cardNumber == test.getCardNumber()) && (this.pin == test.getPin()))
		{
			return true;
		}
		return false;
