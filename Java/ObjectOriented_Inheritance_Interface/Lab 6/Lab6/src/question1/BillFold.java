...
public class BillFold
{
	...
	public void addCard(Card newCard)
	{
		...
		{
			System.out.println("No effects, both cards are set");
		}
	}

	/**
	 * This method will check to determine how many expired cards there are in the current BillFold
	 * @return Will return as an integer value the number of expired cards in the Billfold.
	 */
