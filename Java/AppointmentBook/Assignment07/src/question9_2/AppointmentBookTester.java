...
public class AppointmentBookTester
{
	...
	/**
	 * This method will ask the user for a description of their appointment
	 * @param input The Scanner object necessary to get input from the keyboard
	 * @return Returns the user inputed String
	 */
	...
	/**
	 * This method will ask the user for a date to match with their appointment
	 * @param input The Scanner object necessary to get input from the keyboard
	 * @return Returns the user inputed date
	 */
